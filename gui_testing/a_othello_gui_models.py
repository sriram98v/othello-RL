...
PLAYERS = {a_test_othello.BLACK: 'Black', a_test_othello.WHITE: 'White'}
VICTORY_TYPES = {a_test_othello.MOST_CELLS: 'Most Cells', a_test_othello.LEAST_CELLS: 'Least Cells'}

class GameBoard:
    def __init__(self, game_state: a_test_othello.OthelloGame, game_width: float,
    ...
    def _redraw_cells(self) -> None:
        ...
        for row in range(self._rows):
            for col in range(self._cols):
                if self._game_state.get_board()[row][col] != a_test_othello.NONE:
    ...
    def update_game_state(self, game_state: a_test_othello.OthelloGame) -> None:
...
class Score:
    def __init__(self, color: str, game_state: a_test_othello.OthelloGame, root_window) -> None:
    ...
    def update_score(self, game_state: a_test_othello.OthelloGame) -> None:
...
class Turn:
    def __init__(self, game_state: a_test_othello.OthelloGame, root_window) -> None:
    ...
    def switch_turn(self, game_state: a_test_othello.OthelloGame) -> None:
    ...
    def _opposite_turn(self) -> None:
        ...
        return {a_test_othello.BLACK: a_test_othello.WHITE, a_test_othello.WHITE: a_test_othello.BLACK}[self._player]
